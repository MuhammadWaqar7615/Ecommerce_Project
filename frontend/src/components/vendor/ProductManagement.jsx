...
const ProductManagement = () => {
    ...
    return (
        ...
        >
            ...
            {/* Header - Responsive: stacked on mobile, row on larger screens */}
            <motion.div
                variants={cardVariants}
                className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 sm:p-6 border-b border-gray-100"
            >
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex border border-gray-200 rounded-lg overflow-hidden">
                        <button
                            ...
                            className={`p-2 transition ${viewMode === 'grid' ? 'bg-primary text-white' : 'bg-white text-gray-500 hover:bg-gray-50'}`}
                            title="Grid view"
                        >
                            <Grid3x3 size={18} />
                        </button>
                        <button
                            ...
                            className={`p-2 transition ${viewMode === 'table' ? 'bg-primary text-white' : 'bg-white text-gray-500 hover:bg-gray-50'}`}
                            title="Table view"
                        >
                            <Table2 size={18} />
                        </button>
                    ...
                    <motion.button
                        ...
                        className="flex items-center justify-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition shadow-sm"
                    >
                        <Plus size={18} />
            ...
            <motion.div variants={cardVariants} className="p-4 sm:p-6 pt-4 sm:pt-6">
                <div className="flex flex-col gap-3">
                    {/* First row: Search + Filter + Sort on mobile, but better to wrap */}
                    <div className="flex flex-col sm:flex-row gap-3">
                        <div className="flex-1 relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-white text-sm"
                            />
                            {searchTerm && (
                        ...
                        <div className="flex gap-2">
                            <motion.button
                                ...
                                className={`flex items-center gap-2 px-4 py-2.5 rounded-lg border transition whitespace-nowrap ${isFilterOpen || hasActiveFilters ? 'bg-primary text-white border-primary' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50'}`}
                            >
                                <Filter size={18} />
                                <span>Filters</span>
                                {hasActiveFilters && (
                            ...
                            <select
                                ...
                                className="px-4 py-2.5 border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-primary text-sm"
                            >
                    ...
                    <AnimatePresence>
                        {isFilterOpen && (
                            <motion.div
                                ...
                                animate="visible"
                                exit="exit"
                                className="mt-2 pt-4 border-t border-gray-200 overflow-hidden"
                            >
                        ...
                        <table className="w-full min-w-[640px] sm:min-w-[800px]">
                            <thead className="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    ...
                                    <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Product</th>
                                    <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Category</th>
                                    <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Price</th>
                                    <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Stock</th>
                                    <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Status</th>
                                    <th className="px-3 sm:px-6 py-3 sm:py-4 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider">Actions</th>
                                </tr>
                            </thead>
                                    ...
                                    return (
                                        ...
                                        >
                                            <td className="px-3 sm:px-6 py-3 sm:py-4">
                                                {product.images?.[0] ? (
                                                    <img src={product.images[0]} alt={product.name} className="w-10 h-10 sm:w-12 sm:h-12 object-cover rounded-lg border border-gray-200" />
                                                ) : (
                                            ...
                                            <td className="px-3 sm:px-6 py-3 sm:py-4">
                                                <div className="max-w-[150px] sm:max-w-[200px]">
                                                    <p className="font-medium text-gray-800 mb-0.5 sm:mb-1 truncate text-sm sm:text-base">{product.name}</p>
                                                    <p className="text-xs sm:text-sm text-gray-500 truncate">{product.description || 'No description'}</p>
                                                </div>
                                            </td>
                                            <td className="px-3 sm:px-6 py-3 sm:py-4">
                                                <span className="inline-flex px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-700 whitespace-nowrap">
                                                    {product.category?.name || product.category || 'Uncategorized'}
                                                </span>
                                            </td>
                                            <td className="px-3 sm:px-6 py-3 sm:py-4">
                                                <span className="font-semibold text-gray-800 whitespace-nowrap text-sm sm:text-base">{formatPrice(product.price)}</span>
                                            </td>
                                            <td className="px-3 sm:px-6 py-3 sm:py-4">
                                                <div className="flex items-center gap-1.5">
                                                    <span className={`w-2 h-2 ${stockStatus.dotColor} rounded-full`}></span>
                                                    <span className={`text-xs sm:text-sm ${stockStatus.textColor} font-medium`}>
                                            ...
                                            <td className="px-3 sm:px-6 py-3 sm:py-4">
                                                {product.isVisible ? (
                                                    <span className="inline-flex items-center gap-1 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full text-xs font-medium bg-green-50 text-green-700 whitespace-nowrap">
                                                        <span className="w-1.5 h-1.5 bg-green-500 rounded-full"></span> Visible
                                                    </span>
                                                ) : (
                                                    <span className="inline-flex items-center gap-1 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full text-xs font-medium bg-red-50 text-red-700 whitespace-nowrap">
                                            ...
                                            <td className="px-3 sm:px-6 py-3 sm:py-4">
                                                <div className="flex items-center justify-center gap-1 sm:gap-2">
                                                    <motion.button
                                                        ...
                                                        className="p-1.5 sm:p-2 text-blue-500 hover:bg-blue-50 rounded-lg transition-all"
                                                        title="Edit"
                                                    >
                                                    ...
                                                    <motion.button
                                                        ...
                                                        className={`p-1.5 sm:p-2 rounded-lg transition-all ${product.isVisible ? 'text-yellow-500 hover:bg-yellow-50' : 'text-green-500 hover:bg-green-50'}`}
                                                        title={product.isVisible ? 'Hide' : 'Show'}
                                                    >
                                                        {product.isVisible ? <EyeOff size={16} className="sm:w-[18px] sm:h-[18px]" /> : <Eye size={16} className="sm:w-[18px] sm:h-[18px]" />}
                                                    </motion.button>
                                                    <motion.button
                                                        whileHover={{ scale: 1.1 }}
                                                        whileTap={{ scale: 0.9 }}
                                                        onClick={() => handleDelete(product._id, product.name)}
                                                        className="p-1.5 sm:p-2 text-red-500 hover:bg-red-50 rounded-lg transition-all"
                                                        title="Delete"
                                                    >
                            ...
                            {currentProducts.map((product, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className="group relative bg-white rounded-xl overflow-hidden cursor-pointer border border-gray-100 shadow-sm hover:shadow-md transition-shadow"
                                    >
                                        {/* Image Container */}
                                        <div className="relative aspect-square bg-gray-100 rounded-t-xl overflow-hidden">
                                            ...
                                            {/* Stock Badge */}
                                            {product.stock === 0 && (
                                                <span className="absolute top-2 left-2 px-1.5 py-0.5 bg-gray-800/80 backdrop-blur-sm text-white text-[10px] font-medium rounded-md shadow-sm">
                                                    Out
                                                </span>
                                            )}
                                            {product.stock > 0 && product.stock <= 10 && (
                                                <span className="absolute top-2 left-2 px-1.5 py-0.5 bg-orange-500/90 backdrop-blur-sm text-white text-[10px] font-medium rounded-md shadow-sm">
                                                    Low
                                                </span>
                                            )}
                                        ...
                                        {/* Content */}
                                        <div className="p-3">
                                            <h3 className="font-bold text-primary truncate text-sm sm:text-base">{product.name}</h3>
                                            <div className="flex items-center justify-between mt-1">
                                                <span className="text-primary font-semibold text-sm sm:text-base">
                                                    {formatPrice(product.price)}
                                                </span>
                                                <div className={`${stockStatus.textColor} flex items-center gap-1 text-xs`}>
                                                    <span className={`w-1.5 h-1.5 ${stockStatus.dotColor} rounded-full`}></span>
            ...
            {filteredProducts.length > 0 && totalPages > 1 && (
                <motion.div
                    ...
                    className="flex flex-col sm:flex-row items-center justify-between gap-3 px-4 sm:px-6 py-4 border-t border-gray-100"
                >
                    ...
                    <div className="flex gap-1 sm:gap-2">
                        <motion.button
                            ...
                            className="p-1.5 sm:p-2 rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition"
                        >
                            ...
                            {[...Array(Math.min(totalPages, 5))].map((_, i) => {
                                ...
                                return (
                                    <motion.button
                                        ...
                                        className={`w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center rounded-lg text-sm font-medium transition ${
                                            currentPage === pageNum
            ...
            {/* Modals (unchanged, but ensure they are responsive in their own component) */}
            <AlertConfirmation
