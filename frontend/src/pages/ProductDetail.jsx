          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="md:flex">
              ...
              <div className="md:w-1/2 p-6">
                <div className="text-sm text-primary font-semibold mb-2">{product.category?.name || product.category || 'Uncategorized'}</div>
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          setQuantity(Number.isNaN(value) ? 1 : Math.min(product.stock, Math.max(1, value)));
                        }}
